drop procedure if exists insert_employee(char, varchar, varchar, varchar, varchar, char, date, char, char, char);
...
drop procedure if exists delete_employee(char);
